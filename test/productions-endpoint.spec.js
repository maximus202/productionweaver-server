...
describe('Productions endpoint', () => {
  ...
  describe('GET /api/productions', () => {
    ...
    context('given productions exist', () => {
      ...
      it('responds with 200 and all productions', () => supertest(app)
        .get('/api/productions/')
    ...
    context('given XSS attack', () => {
      ...
      it('removes XSS attack', () => supertest(app)
        ...
        .expect((res) => {
          ...
          expect(res.body[0].production_title).to.eql(
            sanitizedMaliciousProduction.production_title,
          );
  ...
  describe('POST /api/productions', () => {
    context('given fields are missing', () => {
      ...
      it('responds with 400 and an error message when production_title is missing', () => supertest(app)
    ...
    context('given a valid request', () => {
      beforeEach('insert users', () => db
        .insert(testUsers)
        .into('productionweaver_users'));
      it('responds with 201 and the new production', () => supertest(app)
        .post('/api/productions')
        .set('Authorization', makeAuthHeader(testUsers[0]))
