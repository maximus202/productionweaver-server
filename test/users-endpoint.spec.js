...
describe('Users endpoint', () => {
  ...
  describe('GET /api/users', () => {
    ...
    context('given there are no users in the database', () => {
      it('GET /users responds with 200 and all users', () => supertest(app)
        .get('/api/users')
        .expect(200, []));
    });
  ...
  describe('POST /api/users', () => {
    context('given missing fields', () => {
      it('responds with 400 if first name is missing', () => supertest(app)
        .post('/api/users')
      ...
      it('responds with 400 if last name is missing', () => supertest(app)
        .post('/api/users')
        .send(userwithMissingLastName)
        .expect(400, { error: { message: 'last_name missing in request body' } }));
      it('responds with 400 if email is missing', () => supertest(app)
        .post('/api/users')
    ...
    context('given valid data', () => {
      it('responds with 201 and new user', () => supertest(app)
        .post('/api/users')
        .send(newUser)
        .expect(201)
        .then((res) => {
